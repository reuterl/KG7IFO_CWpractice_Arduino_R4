...
public:
    ...
    typedef enum morseElement_e {morseDit=101, morseDah, morseMark, morseSpace, morseWordSpace, morseIdle} morseElement_t;
    ...
    typedef enum proSignCode_e {
    	                        proAA = 1, proAR, proAS, proBT, proCQ, proCT, proEE, proIMI, proKN, proSK, proSN, proSOS
    } proSignCode_t;
